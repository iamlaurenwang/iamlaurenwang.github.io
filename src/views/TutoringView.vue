...
import { LINE_URL } from '@/data/contact'
        ...
        <div class="min-w-0 flex-1">
          ...
          <div class="mt-6">
            <RouterLink
              ...
              class="group inline-flex items-center gap-2 rounded-md bg-accent-600 px-6 py-3 font-sans text-sm font-medium text-white shadow-card transition hover:bg-accent-700"
            >
              <Sparkles :size="16" />
              查看課程
